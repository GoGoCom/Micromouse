...
public:
  ...
  void Init(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, int active); //, bool pullupActive = true);
...
private:
  ...
  callbackFunction _clickFunc = 0; //Null;
  callbackFunction _doubleClickFunc = 0; //null;
  callbackFunction _pressFunc = 0; //NULL;
  callbackFunction _longPressStartFunc = 0; //NULL;
  callbackFunction _longPressStopFunc = 0; //NULL;
  callbackFunction _duringLongPressFunc = 0; //NULL;
